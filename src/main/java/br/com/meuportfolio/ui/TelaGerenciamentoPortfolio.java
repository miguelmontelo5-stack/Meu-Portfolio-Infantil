// Arquivo: TelaGerenciamentoPortfolio.java (Versão Final e Completa)
...
public class TelaGerenciamentoPortfolio extends JDialog {

    private Aluno aluno;
    private MidiaController midiaController;
    private JPanel painelGaleria;

    public TelaGerenciamentoPortfolio(Frame owner, Aluno aluno) {
    ...
    private void carregarMidias() {
        ...
        try {
            List<Midia> midias = midiaController.listarPorAluno(aluno.getId());
    ...
    private void adicionarNovaMidia() {
        ...
        FileNameExtensionFilter filtroImagem = new FileNameExtensionFilter("Imagens (JPG, PNG, GIF)", "jpg", "jpeg", "png", "gif");
        FileNameExtensionFilter filtroDocumento = new FileNameExtensionFilter("Documentos (PDF, DOCX)", "pdf", "docx");
        
        seletorArquivo.addChoosableFileFilter(filtroImagem);
        seletorArquivo.addChoosableFileFilter(filtroDocumento);
        seletorArquivo.setFileFilter(filtroImagem);
            ...
            if (descricao != null && !descricao.trim().isEmpty()) {
                try {
                    ...
                    if(nomeArquivo.endsWith(".jpg") || nomeArquivo.endsWith(".png") || nomeArquivo.endsWith(".gif")) {
                        ...
                        novaMidia.setTipoMidia(Midia.TipoMidia.AUDIO); // Simplificado: podemos adicionar mais tipos no enum
                    }
